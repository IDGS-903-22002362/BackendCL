...
export const LOYALTY_DEFAULTS = {
  ...
  PROFILE_COMPLETION_POINTS: 15,
  SOCIAL_SIGNUP_BONUS_POINTS: 15,
  FICHAJE_BONUS_POINTS: 30,
  ...
  /** 1 FieraPunto = $0.10 MXN al canjear en checkout. */
  POINT_REDEMPTION_VALUE_PESOS: 0.1,
