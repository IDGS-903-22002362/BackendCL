...
export const DEFAULT_HOME_SECCIONES: RecomendacionSeccionConfig[] = [
  {
    id: "home-populares",
    titulo: "Populares",
    subtitulo: "Lo más visto y guardado en favoritos",
    estrategia: RecomendacionEstrategia.POPULARIDAD,
    activo: true,
    limite: 12,
    orden: 1,
  ...
  {
    id: "home-mas-comprados",
    titulo: "Más comprados",
    subtitulo: "Los favoritos de la afición",
