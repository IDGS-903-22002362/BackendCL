# Runbook de rollback — Loyalty v1

1. Desactivar `loyaltyV1WritesEnabled` y `loyaltyRedemptionsEnabled` en Remote Config / `configuracion/loyalty`
2. Mantener `legacyPointsAdaptersEnabled=true`
3. No borrar documentos del ledger
4. Reconciliar movimientos creados durante la ventana de rollback
5. Restaurar Firestore desde backup/PITR solo en staging de prueba antes de producción
